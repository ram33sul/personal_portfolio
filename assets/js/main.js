...
function validate_email() {
  var email = document.form_ram.email.value;
...
function validate_number() {
  var number = document.form_ram.number.value;
  var number2 = /\./.test(number);
  var number3 = number.includes("+");
  if(number.length==0){
    document.getElementById("label_number").style.color='red';
    document.getElementById("label_number").innerHTML='Required';
  }
  else{
  if (isNaN(number)||number2==true||number3==true||number<0){
    document.getElementById("label_number").style.color='red';
    document.getElementById("label_number").innerHTML='Enter a valid mobile number';
  }
  else {
    if (number.length!=10){
      document.getElementById("label_number").style.color='red';
...
function validate_cpassword(){
  var cpassword = document.form_ram.cpassword.value;
  if(password!=0){
